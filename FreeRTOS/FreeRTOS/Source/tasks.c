...
//		#include "xtime_l.h"
//		#include "TimingAttack_Demo/LogUtility.h"
//		//xil_printf("\n\r%d\t%s", xTickCount, pxCurrentTCB->pcTaskName);
//		#define	GET_GTIMER_LOWER_INLINE	*(volatile u32 *) (GLOBAL_TMR_BASEADDR + GTIMER_COUNTER_LOWER_OFFSET)
//		xil_printf("\n\r%d\t%d\t%s", GET_GTIMER_LOWER_INLINE, (u32)(pxCurrentTCB->uxTCBNumber), pxCurrentTCB->pcTaskName);
//		//uxTCBNumber
//		feedLog(ENUM_LOG_SCHEDULER, (u32)(pxCurrentTCB->uxTCBNumber), pxCurrentTCB->pcTaskName);
//		feedLog(ENUM_LOG_SCHEDULER, (u32)(pxCurrentTCB->uxTCBNumber), "SCH");
//		feedLog(ENUM_LOG_SCHEDULER, 0, "");
...
/*-----------------------------------------------------------*/
	...
	int getTaskId(void)
	{
		//int taskId = (u32) (pxCurrentTCB->uxTaskNumber);
		int taskId = (u32)pxCurrentTCB->uxTCBNumber;
		return taskId;
	}

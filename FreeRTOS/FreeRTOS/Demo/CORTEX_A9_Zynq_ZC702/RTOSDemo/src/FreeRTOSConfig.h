...
#define configCPU_CLOCK_HZ						666666687UL // CPU runs at 666.666687MHz //100000000UL
...
#define configMAX_PRIORITIES					( 30 )	// ( 7 )
#define configMINIMAL_STACK_SIZE				1000//( ( unsigned short ) 200 )
#define configTOTAL_HEAP_SIZE					( 8024 * 1024 )//( 80 * 1024 )
...
#define INCLUDE_vTaskSuspend					0//1	// 0 for not blocking task when the queue is empty
